...
- **Privacy policy:** what data is collected, why, how long it's kept, who it's shared with, how users exercise their rights, and the contact for data requests. It must accurately reflect the data the app *actually* collects: auth identities, payment records, AI prompts, push tokens, analytics events, and anything cached or logged.
