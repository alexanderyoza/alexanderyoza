...
1. **Dedupe** — against open *and* fixed entries in BUGS/TWEAKS and
   ...
   — it's a regression: file a fresh `[prod]` bug entry that cites the original
